<?php
/**
 * Página genérica del Maestro de Páginas — URL pública /p/{slug}.
 * Renderiza con cabecera y pie del sitio, estilo uniforme (sin cards ni bordes).
 */
...
function am_render_generic_page_404(): never
{
...
if ($slug === '' || !preg_match('/^[a-z0-9]+(?:-[a-z0-9]+)*$/', $slug)) {
    am_render_generic_page_404();
}

$page = GenericPageService::findBySlug($siteData, $slug, true);
if ($page === null) {
    am_render_generic_page_404();
}
...
$seoOverride = [
    ...
    'canonical' => SeoService::canonicalBaseFromSiteData($siteData) . GenericPageService::publicPath($slug),
];
...
<section class="container pt-4 pb-5 mb-5">
    <article class="generic-page-content font-poppins text-navy fs-6 lh-lg">
        <?php echo $pageHtml; ?>
    </article>
</section>
