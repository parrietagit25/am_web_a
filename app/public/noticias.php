<?php
/**
 * Automarket - Noticias por unidad de negocio
 */
...
$noticias = unit_content_get_items($contentService, $unitKey, 'news');
?>
...
<section class="py-5" style="background-color: #f8f9fc;">
    <div class="container">
        ...
        <p class="text-muted font-poppins mt-2 mb-0">Comunicados, novedades y actualidad.</p>
    </div>
</section>
