...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic CMS Seminuevos-Renting: 5A-B1/B2 cerrados prod; B3 admin CRUD en validación.',
            'dependencias'        => ['AM-CMS-3B3'],
            'ultimo_commit'       => '46b0968',
            'evidencia'           => '5A-B1/B2 cerrados prod; B3 admin columnas en validación local.',
            'siguiente_accion'    => 'Validar AM-CMS-5A-B3 admin CRUD columnas y cerrar en prod.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B',
            ...
            'descripcion'         => 'Builder N columnas. B1+B2 cerrados prod; B3 admin CRUD en validación.',
            'dependencias'        => ['AM-CMS-5A-B0'],
            'ultimo_commit'       => '46b0968',
            'evidencia'           => 'B3: pestaña Columnas CRUD; buildColumnsFromAdminPost; recursos protegida; URLs sanitizadas.',
            'siguiente_accion'    => 'Validar B3 local y cerrar en prod tras revisión.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B1',
        ...
        [
            ...
            'siguiente_accion'    => 'Cerrado. B3 admin CRUD en validación.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B3',
            ...
            'descripcion'         => 'Pestaña Columnas: listar/crear/editar/ordenar/activar columnas y links; guardar footer.columns; recursos protegida; sanitize URLs.',
            'dependencias'        => ['AM-CMS-5A-B2'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Local: admin-footer-tab/actions + FooterService buildColumnsFromAdminPost; php -l; QA columnas/links activos/inactivos.',
            'siguiente_accion'    => 'Revisión y cierre prod tras validación QA.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5B',
