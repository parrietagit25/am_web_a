...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic CMS Seminuevos-Renting: 5A-B1 y 5A-B2 cerrados prod; siguiente B3 admin CRUD.',
            'dependencias'        => ['AM-CMS-3B3'],
            'ultimo_commit'       => '46b0968',
            'evidencia'           => '5A-B1/B2 cerrados prod; 5A-B en desarrollo; B3 admin columnas pendiente.',
            'siguiente_accion'    => 'Iniciar AM-CMS-5A-B3 admin CRUD columnas cuando se apruebe.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B',
            ...
            'descripcion'         => 'Builder N columnas. B1+B2 cerrados prod; B3 admin CRUD pendiente.',
            'dependencias'        => ['AM-CMS-5A-B0'],
            'ultimo_commit'       => '46b0968',
            'evidencia'           => 'B2 prod: getActiveColumns en footer.php; 1 col recursos visual igual; also_know/social/pagos intactos.',
            'siguiente_accion'    => 'AM-CMS-5A-B3 admin CRUD columnas.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B1',
        ...
        [
            ...
            'siguiente_accion'    => 'Cerrado. Siguiente: AM-CMS-5A-B3 admin CRUD columnas.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5B',
