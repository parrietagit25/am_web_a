...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'ultimo_commit'       => '—',
            'evidencia'           => 'unit-contact-cards.php + am_unit_contact_resolved_for_display; reutiliza footer_contact sin segunda fuente.',
            'siguiente_accion'    => 'Validar local; mercadeo edita contactos en admin unidad.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A',
            ...
            'descripcion'         => 'Epic CMS Seminuevos/Renting: contactos en páginas (5A-A) y footer builder pendiente (5A-B).',
            'dependencias'        => ['AM-CMS-3B3'],
            'ultimo_commit'       => '—',
            'evidencia'           => '5A-A en validación; footer builder sin iniciar.',
            'siguiente_accion'    => 'Cerrar 5A-A; iniciar 5A-B footer builder.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B',
