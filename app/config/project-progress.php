...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic: módulo funcional cerrado en AM-CONT-4C-A; AM-CONT-4C-B0 diagnóstico meta/URLs formalizado; sub-bloques B1–B4 definidos; pendiente contenido Mercadeo y sprints B1/B3 según autorización.',
            'dependencias'        => ['AM-CONT-4C-A'],
            'ultimo_commit'       => '16bb81e',
            'evidencia'           => '4C-A cerrado prod; AM-CONT-4C-B0 diagnóstico formal meta/URLs; AM-CONT-6D/6E/6F diagnosticados; artículos reales los carga mercadeo; ~10 noticia.php en sitemap.',
            'siguiente_accion'    => 'Mercadeo publica contenido real; siguiente técnico AM-CONT-4C-B1 meta SEO sin URLs, o B3 /blog/{slug}+301 solo con autorización explícita.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'siguiente_accion'    => 'Ejecutar AM-CONT-4C-B1 para meta SEO dedicada por artículo sin cambiar URLs, o AM-CONT-4C-B3 de URLs amigables /blog/{slug}+301 solo con autorización explícita para tocar rutas/nginx.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'descripcion'         => 'Permitir o preparar meta_title/meta_description por artículo manteniendo noticia.php?id=... como URL pública.',
            'dependencias'        => ['AM-CONT-4C-B0'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Definido en AM-CONT-4C-B0; sin implementación.',
            'siguiente_accion'    => 'Implementar campos SEO dedicados en CMS y noticia.php sin cambiar URLs públicas.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'ultimo_commit'       => '—',
            'evidencia'           => 'Definido en AM-CONT-4C-B0; sin implementación.',
            'siguiente_accion'    => 'Refinar canonical/OG/schema sobre noticia.php?id tras B1 o en paralelo si aplica.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'estado'              => 'Pospuesto',
            'porcentaje_estimado' => 0,
            'descripcion'         => 'Migrar a URLs amigables y redirecciones desde noticia.php?id=...',
            'dependencias'        => ['AM-CONT-4C-B0'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Requiere autorización explícita: impacto en rutas, nginx, canonical, sitemap e indexación (~10 URLs noticia.php actuales). No implementar /blog/{slug} todavía.',
            'siguiente_accion'    => 'No implementar sin autorización explícita para tocar rutas/nginx/canonical/sitemap.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'dependencias'        => ['AM-CONT-4C-B0'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Pendiente de cierre tras sub-bloques B1–B3 aprobados.',
