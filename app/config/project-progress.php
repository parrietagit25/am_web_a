...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic CMS Seminuevos/Renting: 5A-A cerrado; 5A-B0 aprobado; 5A-B1 normalización FooterService en validación.',
            'dependencias'        => ['AM-CMS-3B3'],
            'ultimo_commit'       => '17601fc',
            'evidencia'           => '5A-A cerrado prod; 5A-B0 aprobado; 5A-B1 FooterService columnas en validación local.',
            'siguiente_accion'    => 'Validar B1 y continuar B2 render dinámico.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B',
            ...
            'descripcion'         => 'Builder N columnas (título, links, orden, activo). Opción C híbrida; B1 normalización servicio.',
            'dependencias'        => ['AM-CMS-5A-B0'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'B1: normalizeColumns, getActiveColumns, filterRenderableColumnLinks.',
            'siguiente_accion'    => 'Tras B1: B2 render footer.php dinámico.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B1',
            ...
            'dependencias'        => ['AM-CMS-5A-B0'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'FooterService: defaultFooterColumns, normalizeFooterLink/Column, filterActiveColumns; getFooter() compatible footer.php.',
            'siguiente_accion'    => 'Revisión local; push tras aprobación. Siguiente B2.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5B',
