...
return [
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic CMS Seminuevos/Renting: 5A-A cerrado; 5A-B0 aprobado; 5A-B1 normalización FooterService cerrado prod.',
            'dependencias'        => ['AM-CMS-3B3'],
            'ultimo_commit'       => 'aa87382',
            'evidencia'           => '5A-B1 cerrado prod aa87382; 5A-B en desarrollo; siguiente B2 render.',
            'siguiente_accion'    => 'Iniciar AM-CMS-5A-B2 render dinámico footer.php cuando se apruebe.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B',
            ...
            'descripcion'         => 'Builder N columnas (título, links, orden, activo). Opción C híbrida; B1 cerrado prod.',
            'dependencias'        => ['AM-CMS-5A-B0'],
            'ultimo_commit'       => 'aa87382',
            'evidencia'           => 'B1 prod: normalizeColumns, getActiveColumns; footer visual sin cambio hasta B2.',
            'siguiente_accion'    => 'AM-CMS-5A-B2 render footer.php dinámico.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5A-B1',
            ...
            'siguiente_accion'    => 'Cerrado. Siguiente: AM-CMS-5A-B2 render dinámico.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CMS-5B',
