...
return [
    'meta' => [
        ...
        'version_tablero'  => 'AM-CONT-4C-B3-E',
    ...
    'bloques' => [
        ...
        [
            ...
            'descripcion'         => 'Epic: módulo funcional cerrado en AM-CONT-4C-A; B0/B1 cerrados; epic B3 URLs amigables cerrado (B3-A–B3-E); B2 pendiente; contenido Mercadeo pendiente.',
            'dependencias'        => ['AM-CONT-4C-A'],
            'ultimo_commit'       => 'df7f7dd',
            'evidencia'           => '4C-A cerrado prod; B0/B1 meta SEO cerrados; epic B3 cerrado: slug PHP, ruta /blog/{unit}/{type}/{slug}, canonical/sitemap/schema/OG/listados en URL limpia, 301 desde legacy; 10 /blog en sitemap, 0 noticia.php artículos; contenido editorial pendiente Mercadeo.',
            'siguiente_accion'    => 'Mercadeo publica contenido real; continuar AM-CONT-4C-B2 canonical/schema refinado o próximo bloque priorizado del roadmap; monitorear Search Console tras migración URLs.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
