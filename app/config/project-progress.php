...
return [
    'meta' => [
        ...
        'version_tablero'  => 'AM-DASH-1D',
        'fecha_actualizacion' => '2026-07-23',
        'nota_tablero' => 'Tablero interno de implementación, validación y seguimiento de entregables del proyecto Automarket. Actualizado con cutover BARS SOAP local, lab RAC, catálogo imágenes SIPP, protecciones sin NONE y permisos granulares RAC.',
    ...
    'resumen' => [
        ...
        'rac_integraciones' => 95,
        'pagos_powertranz'  => 80,
    ],

    'pendientes_funcionales' => [
        ['item' => 'Renting — asociación de sucursales', 'nota' => 'Infraestructura de selects desde maestro cerrada; falta que Mercadeo/admin asocie sucursales en Renting → Sucursales. Sin sucursales asociadas, renting-sucursales.php puede mostrar mensaje controlado.'],
    ],

    'notas_operativas' => [
        ['fecha' => '2026-07-23', 'titulo' => 'RAC BARS SOAP local + Lab', 'texto' => 'Reserva/lookup público prioriza BARS SOAP local (fallback Partner configurable). Lab /lab/rac-ciclo.php validó search local_bars_cache y reserva real ConfID. Captcha sigue activo en formulario público. Permisos RAC granulares + manual AM-ADMIN-MANUAL-1C.'],
    ...
    'bloqueados_decision_negocio' => [
        ...
        ['item' => 'Sostenibilidad vs Fundación', 'nota' => 'Sostenibilidad: CMS admin cerrado (Generales → Sostenibilidad → sostenibilidad.php). Fundación: pendiente decisión negocio; sin ruta pública, footer, sitemap ni migración funda-am.'],
    ...
    'evidencias' => [
        ['fecha' => '2026-07-23', 'texto' => 'AM-DASH-1D: tablero recalibrado — rac_integraciones 95%, avance_global 90%; cutover SOAP reserva local, lab ciclo, imágenes SIPP, protecciones default más barata, permisos RAC granulares.'],
        ['fecha' => '2026-07-23', 'texto' => 'AM-RAC-BARS-SOAP-RES local: AutomarketReservationApiService prioriza BarsReservationClient (otavehres/otavehretres); fallback Partner vía RAC_RESERVATION_PARTNER_FALLBACK; rac-reservation responde bars_source.'],
        ['fecha' => '2026-07-23', 'texto' => 'AM-RAC-LAB-CICLO: /lab/rac-ciclo.php + API; search path=local_bars_cache; reserva real Confirmación 653838; lookup SOAP OK; robots Disallow /lab/.'],
        ['fecha' => '2026-07-23', 'texto' => 'AM-RAC-CATALOG-IMG: RacVehicleCatalogService + sipp_code en flota CMS; rac-flow.js no antepone Partner a /assets/; extras protecciones sin NONE, default más barata.'],
        ['fecha' => '2026-07-23', 'texto' => 'AM-ADMIN-PERMS-RAC: permisos rac_aliados, rac_bars_rates, rac_rate_rules, rac_addons, rac_bars_lab; sidebar/guards con compat legado; manual AM-ADMIN-MANUAL-1C.'],
        ...
        ['fecha' => '2026-07-05', 'texto' => 'AM-CMS-SUMMERNOTE cerrado test: editores visuales en términos, requisitos RAC, Renting servicios/sobre/publicaciones y Taller sobre; vista código HTML; contenido legacy conservado.'],
        ['fecha' => '2026-07-05', 'texto' => 'AM-CMS-LOC-MAESTRO cerrado test: sucursales solo en Generales → Sucursales maestro; módulos por unidad con selects; sin alta manual en secundarios.'],
        ['fecha' => '2026-07-05', 'texto' => 'AM-CMS-LOC-MAPAS cerrado test: acordeones con mapas en páginas de sucursales; primer acordeón abierto; fallback sin coordenadas.'],
        ['fecha' => '2026-07-05', 'texto' => 'AM-CMS-LOC-FOOTER cerrado test: footer sin listado completo; Recursos → /sucursales-grupo.php agrupada por unidad; landings sin listados completos.'],
    ...
    'bloques' => [
        ...
        [
            ...
            'siguiente_accion'    => 'Cerrado arquitectura. CMS Sostenibilidad implementado en bloque AM-CMS-SOSTENIBILIDAD. Fundación: esperar decisión de negocio.',
        ...
        [
            ...
            'area'                => 'Contenido/AEO/GEO',
            'prioridad'           => 'Media',
            'estado'              => 'Módulo técnico listo / contenido pendiente Mercadeo',
        ...
        [
            ...
            'area'                => 'SEO técnico / Contenido/AEO/GEO',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado por absorción en B3-D',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Refinamiento canonical/OG/JSON-LD absorbido por AM-CONT-4C-B3-D dentro de la migración a URL limpia; no requiere ejecución independiente.',
            'dependencias'        => ['AM-CONT-4C-B1', 'AM-CONT-4C-B3-D'],
            'ultimo_commit'       => '888e8a7',
            'evidencia'           => 'B2 definido en B0 como refinamiento canonical/OG/schema sobre noticia.php?id; ejecutado de forma integral en B3-D al alinear canonical, sitemap, schema/OG y listados hacia /blog/{unit}/{type}/{slug}. No requiere sprint independiente.',
            'siguiente_accion'    => 'Ninguna; cubierto por AM-CONT-4C-B3-D y cierre B4.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            ...
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Epic URLs amigables cerrado: B3-A slug PHP, B3-B ruta /blog/{unit}/{type}/{slug}, B3-D canonical/sitemap/schema/OG, B3-C 301 legacy, B3-E cierre dashboard.',
            'dependencias'        => ['AM-CONT-4C-B0', 'AM-CONT-4C-B1'],
            'ultimo_commit'       => 'df7f7dd',
            'evidencia'           => 'Migración URLs amigables blog/noticia cerrada en producción: B3-A resolvió artículos por slug, B3-B habilitó /blog/{unit}/{type}/{slug}, B3-D alineó canonical/sitemap/schema/OG/listados hacia URL limpia y B3-C activó redirects 301 desde URLs legacy noticia.php hacia URLs limpias. Validado: 10 URLs legacy redirigen 301, 10 URLs limpias responden 200, sitemap publica 10 /blog y 0 noticia.php para artículos, canonical/OG/JSON-LD apuntan a URL limpia. Sin tocar site_data.json, contenido editorial, Docker ni cambios adicionales de nginx en este cierre.',
            'siguiente_accion'    => 'Continuar con el próximo bloque priorizado del roadmap; mantener B3 como cerrado y monitorear Search Console/SEO tras la migración de URLs.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
        ...
        [
            ...
            'nombre'              => 'Canonical sitemap schema OG hacia URL limpia',
            'area'                => 'SEO técnico',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'detailUrl, SitemapService, canonical, schema/OG y listados apuntan a /blog/{unit}/{type}/{slug}; URLs viejas 200 sin 301.',
        ...
        [
            ...
            'nombre'              => 'Cierre dashboard migración URLs amigables blog/noticia',
            'area'                => 'Infraestructura',
            'prioridad'           => 'Baja',
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Cierre administrativo y recalibración final del epic B3 tras B3-A–B3-D y B3-C.',
            'dependencias'        => ['AM-CONT-4C-B3-A', 'AM-CONT-4C-B3-B', 'AM-CONT-4C-B3-C', 'AM-CONT-4C-B3-D'],
            'ultimo_commit'       => 'df7f7dd',
            'evidencia'           => 'Migración URLs amigables blog/noticia cerrada en producción: B3-A resolvió artículos por slug, B3-B habilitó /blog/{unit}/{type}/{slug}, B3-D alineó canonical/sitemap/schema/OG/listados hacia URL limpia y B3-C activó redirects 301 desde URLs legacy noticia.php hacia URLs limpias. Validado: 10 URLs legacy redirigen 301, 10 URLs limpias responden 200, sitemap publica 10 /blog y 0 noticia.php para artículos, canonical/OG/JSON-LD apuntan a URL limpia. Sin tocar site_data.json, contenido editorial, Docker ni cambios adicionales de nginx en este cierre.',
            'siguiente_accion'    => 'Continuar con el próximo bloque priorizado del roadmap; mantener B3 como cerrado y monitorear Search Console/SEO tras la migración de URLs.',
            'fecha_actualizacion' => '2026-07-03',
        ...
        [
            ...
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Cierre administrativo del epic AM-CONT-4C-B: B0/B1/B3 cerrados; B2 absorbido por B3-D.',
            'dependencias'        => ['AM-CONT-4C-B0', 'AM-CONT-4C-B1', 'AM-CONT-4C-B3', 'AM-CONT-4C-B3-E'],
            'ultimo_commit'       => '72baae1',
            'evidencia'           => 'Cierre administrativo del epic AM-CONT-4C-B: B0 documentó diagnóstico meta/URLs, B1 implementó meta SEO dedicada por artículo sin cambiar URLs, B3-A/B/D/C/E completaron la migración técnica a URLs limpias /blog/{unit}/{type}/{slug} con canonical/sitemap/schema/OG/listados y redirects 301. B2 queda absorbido por B3-D porque el refinamiento canonical/schema se ejecutó dentro de la migración a URL limpia. AM-CONT-4C permanece abierto solo por contenido editorial pendiente de Mercadeo.',
            'siguiente_accion'    => 'Continuar con el próximo bloque priorizado del roadmap o monitorear Search Console/SEO tras la migración; AM-CONT-4C sigue abierto únicamente por pendientes editoriales de Mercadeo.',
            'fecha_actualizacion' => '2026-07-03',
        ],
        [
            'codigo'              => 'AM-CONT-6D',
        ...
        [
            'codigo'              => 'AM-RAC-BARS-RATES',
            'nombre'              => 'Rent A Car — Tarifas BARS/RW Web',
            'area'                => 'Rent A Car / integraciones',
            'prioridad'           => 'Alta',
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Tarifas RAC integradas con BARS/RW Web, reglas comerciales, protecciones, extras, reserva pública y cron automático.',
            'modal_summary'       => 'Rent A Car público opera con BARS/RW Web: consulta de tarifas, persistencia en BD, recálculo con reglas comerciales, admin de tarifas/protecciones/extras y reserva pública. Desde jul-2026 la confirmación de reserva prioriza BARS SOAP local con fallback Partner opcional; captcha y correo se mantienen.',
            'visibility_type'     => 'visible_admin_publico_tecnico',
            'dependencias'        => [],
            'ultimo_commit'       => 'c24afdb',
            'commits'             => ['c24afdb', 'bed56f3', '5f88780', '385b110'],
            'evidencia'           => 'Tarifas finales visibles; protecciones y extras visibles; reserva test confirmada; correo enviado; captcha activo; cron BARS instalado; cutover SOAP local documentado en AM-RAC-BARS-SOAP-RES.',
            'evidence_items'      => [
                'Tarifas finales visibles en cotización pública',
                'Protecciones activas desde admin visibles en extras',
                'Extras desde admin visibles en flujo público',
                'Reserva de prueba confirmada con correo enviado',
                'Captcha activo en test/prod',
                'Cron BARS: schedules PTY 3 días WEB y TBM 4 días WEB; cada 15 min; horarios 06:00, 12:00, 18:00, 23:00',
                'Gateway reserva: BARS SOAP local primero (jul-2026)',
            ],
            'que_se_hizo'         => 'Integración completa BARS/RW Web con tarifas en BD, reglas comerciales, protecciones y extras administrables, frontend público con cotización/reserva, cron de sincronización y validación E2E de reserva real. Extensión jul-2026: reserva/lookup SOAP local vía BarsReservationClient.',
            'admin_locations'     => [
                ['label' => 'Rent A Car → Tarifas BARS', 'url' => '/admin/rac-bars-rates.php'],
                ['label' => 'Rent A Car → Reglas de Tarifas', 'url' => '/admin/rac-rate-rules.php'],
                ['label' => 'Rent A Car → Protecciones y Extras', 'url' => '/admin/rac-addons.php'],
                ['label' => 'Rent A Car → BARS / Partner Lab', 'url' => '/admin/rac-bars-api-lab.php'],
            ],
            'public_locations'    => [
                ['label' => 'Flujo público Rent A Car', 'url' => '/rent-a-car.php'],
                ['label' => 'Resultados / cotización', 'url' => '/resultados.php'],
                ['label' => 'Extras y protecciones', 'url' => '/extras.php'],
                ['label' => 'Reserva pública', 'url' => '/reservar.php'],
            ],
            'technical_locations' => [
                'Cron BARS cada 15 minutos',
                'Schedules PTY 3 días WEB y TBM 4 días WEB',
                'Actualización según horarios 06:00, 12:00, 18:00, 23:00',
                'Reglas internas de recálculo comercial',
                'BarsReservationClient + AutomarketReservationApiService gateway',
            ],
            'blockers'            => [],
            'siguiente_accion'    => 'Monitoreo comercial. Cutover SOAP y lab: ver bloques AM-RAC-BARS-SOAP-RES / AM-RAC-LAB-CICLO.',
            'fecha_actualizacion' => '2026-07-23',
        ],
        [
            'codigo'              => 'AM-RAC-BARS-SOAP-RES',
            'nombre'              => 'Rent A Car — Reserva/lookup BARS SOAP local',
            'area'                => 'Rent A Car / integraciones',
            'prioridad'           => 'Alta',
            'estado'              => 'Cerrado local',
            'porcentaje_estimado' => 95,
            'descripcion'         => 'Gateway de reserva pública prioriza BARS SOAP local (otavehres/otavehretres) con fallback Partner DO configurable; lookup alineado.',
            'modal_summary'       => 'BarsReservationClient crea y consulta reservas en BARS local. AutomarketReservationApiService intenta SOAP primero y, si RAC_RESERVATION_PARTNER_FALLBACK=true, cae a Partner. APIs rac-reservation y rac-reservation-lookup exponen bars_source. Captcha, quotes, addons, BD local y emails se conservan.',
            'visibility_type'     => 'visible_admin_publico_tecnico',
            'dependencias'        => ['AM-RAC-BARS-RATES'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Lab: reserva real ConfID 653838; lookup SOAP OK; smoke create Success; código gateway en AutomarketReservationApiService.',
            'evidence_items'      => [
                'Preferencia ConfID Type=14 sobre Type=34',
                'Extras/coverage en OTA XML',
                'Fallback Partner opcional por config',
                'Respuesta bars_source local_bars_soap | partner_do',
            ],
            'que_se_hizo'         => 'Cliente SOAP reserva/lookup; gateway público; cableado APIs; stubs lab admin; smoke local validado. E2E navegador público pendiente de captcha.',
            'admin_locations'     => [
                ['label' => 'Rent A Car → Reservas RAC', 'url' => '/admin/?tab=rac-reservations'],
                ['label' => 'Rent A Car → BARS / Partner Lab', 'url' => '/admin/rac-bars-api-lab.php'],
            ],
            'public_locations'    => [
                ['label' => 'Reserva pública', 'url' => '/reservar.php'],
            ...
            'technical_locations' => [
                'app/services/BarsReservationClient.php',
                'app/services/AutomarketReservationApiService.php',
                'app/api/rac-reservation.php',
                'app/api/rac-reservation-lookup.php',
                'RAC_RESERVATION_PARTNER_FALLBACK',
            ],
            'blockers'            => ['Captcha público impide E2E completo en navegador sin bypass'],
            'siguiente_accion'    => 'Validar una reserva pública real tras captcha o bypass autorizado; monitorear bars_source en prod.',
            'fecha_actualizacion' => '2026-07-23',
        ],
        [
            'codigo'              => 'AM-RAC-LAB-CICLO',
            'nombre'              => 'Rent A Car — Lab ciclo BARS (sandbox)',
            'area'                => 'Rent A Car / diagnóstico',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado local',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Sandbox /lab/rac-ciclo.php para status, branches, search, reserve y lookup fuera de web/admin públicos.',
            'modal_summary'       => 'Lab con auth opcional LAB_RAC_SECRET; search usa misma lógica que disponibilidad (caché BARS local → Partner); reserva/lookup SOAP local con selector Partner. robots.txt Disallow /lab/.',
            'visibility_type'     => 'visible_admin_tecnico_no_publico',
            'dependencias'        => ['AM-RAC-BARS-SOAP-RES'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Usuario validó search path=local_bars_cache; dry-run OTA; reserva Confirmación 653838; lookup SOAP OK.',
            'que_se_hizo'         => 'Página + API lab, gate auth, integración BarsReservationClient/BarsApiLabService, robots Disallow.',
            'admin_locations'     => [
                ['label' => 'Lab sandbox', 'url' => '/lab/rac-ciclo.php'],
                ['label' => 'Admin BARS Lab', 'url' => '/admin/rac-bars-api-lab.php'],
            ],
            'public_locations'    => [],
            'public_locations_note' => 'No es superficie pública de cliente; protegido y noindex.',
            'technical_locations' => [
                'app/public/lab/rac-ciclo.php',
                'app/public/lab/rac-ciclo-api.php',
                'app/includes/lab-rac-auth.php',
                'LAB_RAC_SECRET',
            ],
            'blockers'            => [],
            'siguiente_accion'    => 'Cerrado. Usar solo con autorización; puede crear reservas reales.',
            'fecha_actualizacion' => '2026-07-23',
        ],
        [
            'codigo'              => 'AM-RAC-CATALOG-IMG',
            'nombre'              => 'Rent A Car — Imágenes buscador + SIPP + protecciones',
            'area'                => 'Rent A Car / UX',
            'prioridad'           => 'Alta',
            'estado'              => 'Cerrado local',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Enriquecimiento de fotos en resultados BARS vía catálogo Partner + CMS SIPP; protecciones sin NONE y default más barata.',
            'modal_summary'       => 'RacVehicleCatalogService cachea Partner /api/catalog y empareja CMS por nombre/SIPP. Campo sipp_code en flota admin. rac-flow.js no prefixea Partner a /assets/. extras.php: solo protecciones activas; default más económica; backend fuerza si viene vacío/NONE.',
            'visibility_type'     => 'visible_admin_publico',
            'dependencias'        => ['AM-RAC-BARS-RATES'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Imágenes CMS en resultados locales; extras sin opción Sin protección; RacAddonService resolveReservationAddons fuerza más barata.',
            'que_se_hizo'         => 'Servicio catálogo, campo SIPP, fix resolveImage, rac-extras.js sin NONE hardcodeado, default más barata.',
            'admin_locations'     => [
                ['label' => 'Rent A Car → Vehículos / Flota', 'url' => '/admin/?tab=vehicles'],
                ['label' => 'Rent A Car → Protecciones y Extras', 'url' => '/admin/rac-addons.php'],
            ],
            'public_locations'    => [
                ['label' => 'Resultados', 'url' => '/resultados.php'],
                ['label' => 'Extras', 'url' => '/extras.php'],
            ],
            'technical_locations' => [
                'RacVehicleCatalogService',
                'RacPublicRateService::getPublicRates',
                'rac-flow.js / rac-extras.js',
            ],
            'blockers'            => [],
            'siguiente_accion'    => 'Mercadeo: completar sipp_code en flota donde falte foto.',
            'fecha_actualizacion' => '2026-07-23',
        ],
        [
            'codigo'              => 'AM-ADMIN-PERMS-RAC',
            'nombre'              => 'Admin — Permisos granulares Rent A Car + manual',
            'area'                => 'Admin / seguridad',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado local',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Nuevos permisos rac_aliados, rac_bars_rates, rac_rate_rules, rac_addons, rac_bars_lab; sidebar y guards; manual AM-ADMIN-MANUAL-1C.',
            'modal_summary'       => 'AdminPermissionRegistry y tabSlugOrder ampliados. Pantallas BARS/reglas/addons aceptan permiso específico o legado vehicles/rac_reservations. Lab acepta rac_bars_lab o super admin. Manual actualizado (reservas SOAP, lab, SIPP, protecciones, permisos).',
            'visibility_type'     => 'visible_admin',
            'dependencias'        => [],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Claves en registry; sidebar admin_can_any; guards rac-bars-rates/rate-rules/addons/lab; manual secciones 2.8 y 4.9–4.15.',
            'que_se_hizo'         => 'Permisos + menú + guards API/páginas + documentación manual y tablero.',
            'admin_locations'     => [
                ['label' => 'Generales → Usuarios', 'url' => '/admin/?tab=users'],
                ['label' => 'Generales → Manual de uso', 'url' => '/admin/?tab=user-manual'],
            ],
            'public_locations'    => [],
            'technical_locations' => [
                'AdminPermissionRegistry',
                'AdminUserService::tabSlugOrder',
                'admin-sidebar-nav.php',
                'admin-user-manual-tab.php',
            ],
            'blockers'            => [],
            'siguiente_accion'    => 'Reasignar permisos de usuarios operativos en Generales → Usuarios.',
            'fecha_actualizacion' => '2026-07-23',
        ],
        [
            'codigo'              => 'AM-RAC-PAY-POWERTRANZ',
            'nombre'              => 'Rent A Car — Pasarela Powertranz/FAC',
            'area'                => 'Rent A Car / pagos',
            'prioridad'           => 'Alta',
            'estado'              => 'Pendiente externo',
            'porcentaje_estimado' => 80,
            'descripcion'         => 'Integración Powertranz aislada con alive e init HPP funcionando. Bloqueada por Hosted Page no asignada o PageSet/PageName inválidos.',
            'modal_summary'       => 'Módulo Powertranz aislado: cliente, endpoints alive/init/return/status, tabla de pagos de prueba y modo diagnóstico. Init HPP $1.00 responde SP4 con RedirectData y SpiToken, pero el formulario HPP falla con error 757 (Hosted page not found). No conectado a reservas reales ni checkout público.',
            'visibility_type'     => 'visible_admin_tecnico_no_publico',
            'dependencias'        => ['AM-RAC-BARS-RATES'],
            'ultimo_commit'       => 'ebad3ac',
            'commits'             => ['ebad3ac', 'a5130ed', '0ca01f9', '5323b6b'],
            'evidencia'           => 'Alive OK; Init $1.00 OK; ISO SP4; RedirectData presente; SpiToken presente; HPP error 757 Hosted page not found.',
            'evidence_items'      => [
                'Alive OK',
                'Init HPP $1.00 OK',
                'ISO SP4 — SPI Preprocessing complete',
                'RedirectData presente (redactado en UI/BD)',
            ...
            'technical_locations' => [
                ...
                'Tabla rac_powertranz_payments',
                'Endpoints alive / init / return / status',
                'Modo diagnóstico — completePayment automático bloqueado',
                'Credenciales solo en config.php privado (no expuestas)',
            ],
            'blockers'            => [
                'HPP error 757 — Hosted page not found',
                'PageSet usado: GFRHPP; PageName usado: HPPBilling1 (valores de ejemplo PDF, no confirmados para merchant staging 77700791)',
                'FAC/Powertranz debe confirmar PageSet/PageName reales o habilitar Hosted Page HPP para merchant staging 77700791',
            ],
            'test_links'          => [
        ...
        [
            'codigo'              => 'AM-DASH-1A',
            'nombre'              => 'Dashboard de avances en admin',
            'area'                => 'Infraestructura',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Tablero de avances accesible desde admin → Generales → Dashboard de avances, con modales detallados por bloque.',
            'visibility_type'     => 'visible_admin_tecnico_no_publico',
            'dependencias'        => ['AM-DASH-0F'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Pantalla admin project-progress-dashboard.php; menú Generales; bloques RAC BARS y Powertranz documentados.',
            'admin_locations'     => [
                ['label' => 'Generales → Dashboard de avances', 'url' => '/admin/project-progress-dashboard.php'],
            ],
            'siguiente_accion'    => 'Mantener project-progress.php actualizado al cerrar bloques; UI sin referencias a repositorio.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-CMS-SUMMERNOTE',
            'nombre'              => 'Editores HTML Summernote en admin',
            'area'                => 'CMS editorial',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Campos HTML con editor visual Summernote: términos, requisitos RAC, Renting servicios/sobre/publicaciones, Taller sobre. Vista código HTML; contenido anterior conservado.',
            'dependencias'        => [],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Admin: editores Summernote operativos; vista código; sin scripts; smoke guardar y revisar frontend.',
            'admin_locations'     => [
                ['label' => 'Generales → Términos y condiciones', 'url' => '/admin/?tab=terminos'],
                ['label' => 'Renting → Servicios / Sobre / Publicaciones', 'url' => '/admin/?tab=renting-servicios'],
                ['label' => 'Taller → Sobre nosotros', 'url' => '/admin/?tab=taller-sobre'],
            ],
            'siguiente_accion'    => 'Cerrado. Mercadeo puede editar contenido; revisar frontend tras cambios.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-CMS-LOC-MAESTRO',
            'nombre'              => 'Sucursales maestro y selects por unidad',
            'area'                => 'CMS editorial',
            'prioridad'           => 'Alta',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Alta/edición solo en Generales → Sucursales maestro. Módulos RAC, Seminuevos, Leasing, Renting y Taller seleccionan sucursales existentes.',
            'dependencias'        => ['AM-SEO-3C'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Admin maestro + selects por unidad; sin creación manual en módulos secundarios; manual admin documentado.',
            'admin_locations'     => [
                ['label' => 'Generales → Sucursales maestro', 'url' => '/admin/?tab=locations-master'],
            ],
            'siguiente_accion'    => 'Cerrado. Renting: pendiente asociación de sucursales por Mercadeo.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-CMS-LOC-MAPAS',
            'nombre'              => 'Mapas en acordeones de sucursales',
            'area'                => 'UX / frontend',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Páginas de sucursales con acordeones y mapas; primer acordeón abierto por defecto; placeholder si faltan coordenadas.',
            'dependencias'        => ['AM-CMS-LOC-MAESTRO'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Smoke páginas sucursales por unidad; mapa carga o fallback controlado.',
            'public_locations'    => [
                ['label' => 'Sucursales RAC', 'url' => '/sucursales.php'],
                ['label' => 'Sucursales Seminuevos', 'url' => '/seminuevos-sucursales.php'],
                ['label' => 'Sucursales Leasing', 'url' => '/leasing-sucursales.php'],
                ['label' => 'Sucursales Renting', 'url' => '/renting-sucursales.php'],
                ['label' => 'Sucursales Taller', 'url' => '/taller-sucursales.php'],
            ],
            'siguiente_accion'    => 'Cerrado. Completar coordenadas en maestro donde falten.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-CMS-LOC-FOOTER',
            'nombre'              => 'Footer limpio + Recursos → Sucursales agrupadas',
            'area'                => 'UX / frontend',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Footer sin listado completo de sucursales. Enlace Recursos → /sucursales-grupo.php agrupada por unidad. Landings sin listados completos.',
            'dependencias'        => ['AM-CMS-LOC-MAESTRO'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Footer limpio; sucursales-grupo.php agrupa por unidad; homes sin listado completo.',
            'public_locations'    => [
                ['label' => 'Sucursales del grupo', 'url' => '/sucursales-grupo.php'],
            ],
            'siguiente_accion'    => 'Cerrado.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-CMS-SOSTENIBILIDAD',
            'nombre'              => 'Sostenibilidad editable desde admin',
            'area'                => 'CMS editorial',
            'prioridad'           => 'Media',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Generales → Sostenibilidad edita sostenibilidad.php. Fallback hasta primer guardado; luego CMS global.sostenibilidad_page.',
            'dependencias'        => ['AM-CMS-6C'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Admin tab sostenibilidad; página pública con fallback; permiso footer; smoke 200.',
            'admin_locations'     => [
                ['label' => 'Generales → Sostenibilidad', 'url' => '/admin/?tab=sostenibilidad'],
            ],
            'public_locations'    => [
                ['label' => 'Sostenibilidad', 'url' => '/sostenibilidad.php'],
            ],
            'siguiente_accion'    => 'Cerrado. Mercadeo puede cargar contenido final.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-HOTFIX-SESSION-DETALLE',
            'nombre'              => 'Hotfix — ficha vehículo sin warning público',
            'area'                => 'Infraestructura',
            'prioridad'           => 'Alta',
            'estado'              => 'Cerrado producción test',
            'porcentaje_estimado' => 100,
            'descripcion'         => 'Corrección warning session_start antes de output en fichas de vehículos /autos/...',
            'dependencias'        => ['AM-INV-4B'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Fichas /autos/... cargan sin warning visible en frontend.',
            'public_locations'    => [
        ...
        [
            'codigo'              => 'AM-CMS-LOC-MIGRATE',
            'nombre'              => 'Migración legacy location_refs (--apply)',
            'area'                => 'CMS editorial',
            'prioridad'           => 'Baja',
            'estado'              => 'Fase 2 controlada',
            'porcentaje_estimado' => 0,
            'descripcion'         => 'Script dry-run de migración location_refs documentado; --apply pendiente autorización explícita.',
            'dependencias'        => ['AM-CMS-LOC-MAESTRO'],
            'ultimo_commit'       => '—',
            'evidencia'           => 'Dry-run y reportes en app/storage/audits; site_data.json sin --apply.',
            'siguiente_accion'    => 'No ejecutar --apply sin autorización. Fase 2.',
            'fecha_actualizacion' => '2026-07-05',
        ],
        [
            'codigo'              => 'AM-INV-LOCATION-ID',
            'nombre'              => 'Inventario SQL LocationName → location_id',
            'area'                => 'Infraestructura',
            'prioridad'           => 'Baja',
            'estado'              => 'Fase 2',
            'porcentaje_estimado' => 0,
            'descripcion'         => 'Normalización inventario SQL con location_id del maestro. Fuera de alcance del sprint actual; no tocado.',
            'dependencias'        => ['AM-CMS-LOC-MAESTRO'],
            'ultimo_commit'       => '—',
