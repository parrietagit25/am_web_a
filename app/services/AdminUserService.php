...
class AdminUserService
{
    ...
    public static function tabSlugOrder(): array
    {
        return [
            ...
            'seo' => 'seo',
            'landings' => 'landings',
            'generic-pages' => 'generic_pages',
            'sostenibilidad' => 'footer',
            'footer' => 'footer',
            'users' => 'users',
            'audit-log' => 'audit_log',
            'telemetry' => 'telemetry',
            'rentacar-general' => 'news',
            'hero' => 'hero',
            'rentacar-content-config' => 'news',
            'rentacar-content-latest' => 'news',
            'rentacar-content-news' => 'news',
            'rentacar-content-blog' => 'news',
            'opinions' => 'opinions',
            'vehicles' => 'vehicles',
            'rac-aliados' => 'rac_aliados',
            ...
            'rac-bars-rates' => 'rac_bars_rates',
            'rac-rate-rules' => 'rac_rate_rules',
            'rac-addons' => 'rac_addons',
            'rac-bars-api-lab' => 'rac_bars_lab',
            'seminuevos-general' => 'semi_home',
            'semi-home' => 'semi_home',
            'seminuevos-content-config' => 'semi_home',
            'seminuevos-content-latest' => 'semi_home',
            'seminuevos-content-news' => 'semi_home',
            'seminuevos-content-blog' => 'semi_home',
            'semi-inventory' => 'semi_inventory',
            'semi-opinions' => 'semi_opinions',
            'semi-financing' => 'semi_financing',
            'semi-team' => 'semi_team',
            'semi-sucursales' => 'semi_contact',
            'semi-contact' => 'semi_contact',
            'seminuevos-footer' => 'semi_home',
            'leasing-general' => 'leasing_home',
            'leasing-home' => 'leasing_home',
            'leasing-content-config' => 'leasing_home',
            'leasing-content-latest' => 'leasing_home',
            'leasing-content-news' => 'leasing_home',
            ...
            'renting-general' => 'renting_publicaciones',
            'renting-home' => 'renting_home',
            'renting-content-config' => 'renting_publicaciones',
            'renting-content-latest' => 'renting_publicaciones',
            'renting-content-news' => 'renting_publicaciones',
            'renting-content-blog' => 'renting_publicaciones',
            ...
            'renting-sucursales' => 'renting_sucursales',
            'renting-footer' => 'renting_home',
            'taller-general' => 'taller_home',
            'taller-home' => 'taller_home',
            'taller-content-config' => 'taller_home',
            'taller-content-latest' => 'taller_home',
            'taller-content-news' => 'taller_home',
            'taller-content-blog' => 'taller_home',
