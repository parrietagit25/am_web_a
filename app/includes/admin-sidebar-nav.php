...
$generalesTabs = ['user-manual', 'project-progress-dashboard', 'global', 'resend-test', 'pago-test', 'global-sucursales', 'locations-master', 'seo', 'landings', 'generic-pages', 'sostenibilidad', 'careers', 'institutional', 'footer', 'users', 'audit-log', 'telemetry'];
...
$leasingTabs = array_merge([UnitContentService::generalTabSlug('leasing'), 'leasing-home'], $leasingContentTabs, ['leasing-opiniones', 'leasing-sucursales', 'leasing-flota', 'leasing-aliados', 'leasing-equipo', 'leasing-sobre', 'leasing-contacto', 'leasing-footer']);
$rentingContentTabs = UnitContentService::contentTabSlugs('renting');
$rentingTabs = array_merge([UnitContentService::generalTabSlug('renting'), 'renting-home'], $rentingContentTabs, ['renting-servicios', 'renting-sobre', 'renting-publicaciones', 'renting-contacto', 'renting-cotizaciones', 'renting-marcas', 'renting-opiniones', 'renting-sucursales', 'renting-footer']);
$tallerContentTabs = UnitContentService::contentTabSlugs('taller');
$tallerTabs = array_merge([UnitContentService::generalTabSlug('taller'), 'taller-home'], $tallerContentTabs, ['taller-opiniones', 'taller-contacto', 'taller-sobre', 'taller-sucursales', 'taller-footer']);
...
<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <?php if ($showGenerales): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($generalesTabs, $defaultAdminTab); ?>" id="generales-submenu" data-bs-parent="#admin-sidebar-accordion">
            ...
            <a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link<?php echo ($defaultAdminTab ?? '') === 'resend-test' ? ' active' : ''; ?>" href="/admin/resend-test.php">
                <i class="bi bi-envelope-check me-2"></i> Prueba de correo
            </a>
            <?php endif; ?>
            <?php if (AdminUserService::isSuperAdmin()): ?>
            <a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link<?php echo ($defaultAdminTab ?? '') === 'pago-test' ? ' active' : ''; ?>" href="/admin/pago-test.php">
                <i class="bi bi-credit-card-2-front me-2"></i> Pago test
            </a>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if (admin_can('generic_pages')): ?>
            <button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('generic-pages', $defaultAdminTab); ?>" id="tab-generic-pages-nav" data-bs-toggle="pill" data-bs-target="#tab-generic-pages" type="button" role="tab" data-admin-perm="generic_pages">
                <i class="bi bi-file-earmark-richtext me-2"></i> Maestro de Páginas
            </button>
            <?php endif; ?>
            <?php if (admin_can('sostenibilidad')): ?>
            <button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('sostenibilidad', $defaultAdminTab); ?>" id="tab-sostenibilidad-nav" data-bs-toggle="pill" data-bs-target="#tab-sostenibilidad" type="button" role="tab" data-admin-perm="sostenibilidad">
                <i class="bi bi-leaf-fill me-2"></i> Sostenibilidad
            </button>
            <?php endif; ?>
            <?php if (admin_can('careers')): ?>
            <button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('careers', $defaultAdminTab); ?>" id="tab-careers-nav" data-bs-toggle="pill" data-bs-target="#tab-careers" type="button" role="tab" data-admin-perm="careers">
                <i class="bi bi-briefcase-fill me-2"></i> Trabaja con nosotros
            </button>
            <?php endif; ?>
            <?php if (admin_can('institutional')): ?>
            <button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('institutional', $defaultAdminTab); ?>" id="tab-institutional-nav" data-bs-toggle="pill" data-bs-target="#tab-institutional" type="button" role="tab" data-admin-perm="institutional">
                <i class="bi bi-file-earmark-text me-2"></i> Páginas institucionales
            </button>
            <?php endif; ?>
    ...
    <?php if ($showRentacar): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($rentacarTabs, $defaultAdminTab); ?>" id="rentacar-submenu" data-bs-parent="#admin-sidebar-accordion">
            ...
            <?php if (admin_can('rac_promo_codes')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('rac-promo-codes', $defaultAdminTab); ?>" id="tab-rac-promo-codes-nav" data-bs-toggle="pill" data-bs-target="#tab-rac-promo-codes" type="button" role="tab" data-admin-perm="rac_promo_codes"><i class="bi bi-ticket-perforated-fill me-2"></i> Promo-Code</button><?php endif; ?>
            <?php if (admin_can_any(['rac_bars_rates', 'rac_reservations', 'vehicles'])): ?>
            <a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link<?php echo admin_nav_active('rac-bars-rates', $defaultAdminTab); ?>" href="/admin/rac-bars-rates.php" data-admin-perm="rac_bars_rates">
                <i class="bi bi-database-fill-gear me-2"></i> Tarifas BARS / Cache
            </a>
            <?php endif; ?>
            ...
            <?php if (admin_can_any(['rac_aliados', 'vehicles'])): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('rac-aliados', $defaultAdminTab); ?>" id="tab-rac-aliados-nav" data-bs-toggle="pill" data-bs-target="#tab-rac-aliados" type="button" role="tab" data-admin-perm="rac_aliados"><i class="bi bi-award-fill me-2"></i> Aliados y marcas</button><?php endif; ?>
            ...
            <?php if (admin_can('pago_seguro')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('pago-seguro', $defaultAdminTab); ?>" id="tab-pago-seguro-nav" data-bs-toggle="pill" data-bs-target="#tab-pago-seguro" type="button" role="tab" data-admin-perm="pago_seguro"><i class="bi bi-credit-card-2-front-fill me-2"></i> Paga tu reserva</button><?php endif; ?>
            ...
            <?php if (admin_can('rac_reservations')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('rac-reservations', $defaultAdminTab); ?>" id="tab-rac-reservations-nav" data-bs-toggle="pill" data-bs-target="#tab-rac-reservations" type="button" role="tab" data-admin-perm="rac_reservations"><i class="bi bi-journal-text me-2"></i> Registro de reservas</button><?php endif; ?>
            <?php if (admin_can('rac_reservas_man')): ?>
            <a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link" href="/reservas_man/">
                <i class="bi bi-phone me-2"></i> Mostrador (móvil)
            </a>
            <?php endif; ?>
            <?php if (admin_can('hero')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('rentacar-footer', $defaultAdminTab); ?>" id="tab-rentacar-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-rentacar-footer" type="button" role="tab" data-admin-perm="hero"><i class="bi bi-layout-text-window-reverse me-2"></i> Pie de página</button><?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if ($showSeminuevos): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($seminuevosTabs, $defaultAdminTab); ?>" id="seminuevos-submenu" data-bs-parent="#admin-sidebar-accordion">
            <?php if (admin_can(UnitContentService::contentPermissionKey('seminuevos'))): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('seminuevos-general', $defaultAdminTab); ?>" id="tab-seminuevos-general-nav" data-bs-toggle="pill" data-bs-target="#tab-seminuevos-general" type="button" role="tab" data-admin-perm="<?php echo esc(UnitContentService::contentPermissionKey('seminuevos')); ?>"><i class="bi bi-gear-fill me-2"></i> Generales</button><?php endif; ?>
            ...
            <?php if (admin_can('semi_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('semi-sobre', $defaultAdminTab); ?>" id="tab-semi-sobre-nav" data-bs-toggle="pill" data-bs-target="#tab-semi-sobre" type="button" role="tab" data-admin-perm="semi_home"><i class="bi bi-info-circle-fill me-2"></i> Sobre Nosotros</button><?php endif; ?>
            ...
            <?php if (admin_can('semi_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('seminuevos-footer', $defaultAdminTab); ?>" id="tab-seminuevos-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-seminuevos-footer" type="button" role="tab" data-admin-perm="semi_home"><i class="bi bi-layout-text-window-reverse me-2"></i> Pie de página</button><?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if ($showLeasing): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($leasingTabs, $defaultAdminTab); ?>" id="leasing-submenu" data-bs-parent="#admin-sidebar-accordion">
            <?php if (admin_can(UnitContentService::contentPermissionKey('leasing'))): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('leasing-general', $defaultAdminTab); ?>" id="tab-leasing-general-nav" data-bs-toggle="pill" data-bs-target="#tab-leasing-general" type="button" role="tab" data-admin-perm="<?php echo esc(UnitContentService::contentPermissionKey('leasing')); ?>"><i class="bi bi-gear-fill me-2"></i> Generales</button><?php endif; ?>
            ...
            <?php if (admin_can_any(['leasing_opiniones', 'leasing_home'])): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('leasing-opiniones', $defaultAdminTab); ?>" id="tab-leasing-opiniones-nav" data-bs-toggle="pill" data-bs-target="#tab-leasing-opiniones" type="button" role="tab" data-admin-perm="leasing_opiniones"><i class="bi bi-chat-left-quote-fill me-2"></i> Opiniones</button><?php endif; ?>
            ...
            <?php if (admin_can_any(['leasing_aliados', 'leasing_flota'])): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('leasing-aliados', $defaultAdminTab); ?>" id="tab-leasing-aliados-nav" data-bs-toggle="pill" data-bs-target="#tab-leasing-aliados" type="button" role="tab" data-admin-perm="leasing_aliados"><i class="bi bi-award-fill me-2"></i> Aliados y marcas</button><?php endif; ?>
            ...
            <?php if (admin_can('leasing_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('leasing-sobre', $defaultAdminTab); ?>" id="tab-leasing-sobre-nav" data-bs-toggle="pill" data-bs-target="#tab-leasing-sobre" type="button" role="tab" data-admin-perm="leasing_home"><i class="bi bi-info-circle-fill me-2"></i> Sobre Nosotros</button><?php endif; ?>
            ...
            <?php if (admin_can('leasing_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('leasing-footer', $defaultAdminTab); ?>" id="tab-leasing-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-leasing-footer" type="button" role="tab" data-admin-perm="leasing_home"><i class="bi bi-layout-text-window-reverse me-2"></i> Pie de página</button><?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if ($showRenting): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($rentingTabs, $defaultAdminTab); ?>" id="renting-submenu" data-bs-parent="#admin-sidebar-accordion">
            <?php if (admin_can(UnitContentService::contentPermissionKey('renting'))): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('renting-general', $defaultAdminTab); ?>" id="tab-renting-general-nav" data-bs-toggle="pill" data-bs-target="#tab-renting-general" type="button" role="tab" data-admin-perm="<?php echo esc(UnitContentService::contentPermissionKey('renting')); ?>"><i class="bi bi-gear-fill me-2"></i> Generales</button><?php endif; ?>
            ...
            <?php if (admin_can('renting_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('renting-footer', $defaultAdminTab); ?>" id="tab-renting-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-renting-footer" type="button" role="tab" data-admin-perm="renting_home"><i class="bi bi-layout-text-window-reverse me-2"></i> Pie de página</button><?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if ($showTaller): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($tallerTabs, $defaultAdminTab); ?>" id="taller-submenu" data-bs-parent="#admin-sidebar-accordion">
            <?php if (admin_can(UnitContentService::contentPermissionKey('taller'))): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('taller-general', $defaultAdminTab); ?>" id="tab-taller-general-nav" data-bs-toggle="pill" data-bs-target="#tab-taller-general" type="button" role="tab" data-admin-perm="<?php echo esc(UnitContentService::contentPermissionKey('taller')); ?>"><i class="bi bi-gear-fill me-2"></i> Generales</button><?php endif; ?>
            ...
            <?php if (admin_can_any(['taller_opiniones', 'taller_home', 'taller_sobre'])): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('taller-opiniones', $defaultAdminTab); ?>" id="tab-taller-opiniones-nav" data-bs-toggle="pill" data-bs-target="#tab-taller-opiniones" type="button" role="tab" data-admin-perm="taller_opiniones"><i class="bi bi-chat-left-quote-fill me-2"></i> Opiniones</button><?php endif; ?>
            ...
            <?php if (admin_can('taller_home')): ?><button class="nav-link text-start w-100 border-0 bg-transparent<?php echo admin_nav_active('taller-footer', $defaultAdminTab); ?>" id="tab-taller-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-taller-footer" type="button" role="tab" data-admin-perm="taller_home"><i class="bi bi-layout-text-window-reverse me-2"></i> Pie de página</button><?php endif; ?>
        </div>
    <?php endif; ?>
