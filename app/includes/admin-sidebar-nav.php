...
<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    <?php if ($showMain || $showMainAudit || $showMainTelemetry): ?>
        ...
        <button class="nav-link text-start<?php echo admin_nav_active('global', $defaultAdminTab); ?>" id="tab-global-nav" data-bs-toggle="pill" data-bs-target="#tab-global" type="button" role="tab" aria-controls="tab-global" aria-selected="<?php echo admin_nav_selected('global', $defaultAdminTab); ?>" data-admin-perm="global">
            <i class="bi bi-gear-fill me-2"></i> Configuración Global
        </button>
        <?php endif; ?>
        <?php if (admin_can('translations')): ?>
        <button class="nav-link text-start<?php echo admin_nav_active('translations', $defaultAdminTab); ?>" id="tab-translations-nav" data-bs-toggle="pill" data-bs-target="#tab-translations" type="button" role="tab" data-admin-perm="translations">
            <i class="bi bi-translate me-2"></i> Traducciones (ES / EN)
        </button>
        <?php endif; ?>
        <?php if (admin_can('seo')): ?>
        <button class="nav-link text-start<?php echo admin_nav_active('seo', $defaultAdminTab); ?>" id="tab-seo-nav" data-bs-toggle="pill" data-bs-target="#tab-seo" type="button" role="tab" data-admin-perm="seo">
            <i class="bi bi-search me-2"></i> SEO (Global / Página)
        </button>
        <?php endif; ?>
        <?php if (admin_can('landings')): ?>
        <button class="nav-link text-start<?php echo admin_nav_active('landings', $defaultAdminTab); ?>" id="tab-landings-nav" data-bs-toggle="pill" data-bs-target="#tab-landings" type="button" role="tab" data-admin-perm="landings">
            <i class="bi bi-bullseye me-2"></i> Landing Pages
        </button>
        <?php endif; ?>
        <?php if (admin_can('footer')): ?>
        <button class="nav-link text-start<?php echo admin_nav_active('footer', $defaultAdminTab); ?>" id="tab-footer-nav" data-bs-toggle="pill" data-bs-target="#tab-footer" type="button" role="tab" data-admin-perm="footer">
        ...
        <button class="nav-link text-start<?php echo admin_nav_active('telemetry', $defaultAdminTab); ?>" id="tab-telemetry-nav" data-bs-toggle="pill" data-bs-target="#tab-telemetry" type="button" role="tab" data-admin-perm="telemetry">
