...
$generalesTabs = ['user-manual', 'project-progress-dashboard', 'global', 'global-sucursales', 'locations-master', 'translations', 'seo', 'landings', 'generic-pages', 'sostenibilidad', 'footer', 'users', 'audit-log', 'telemetry'];
$rentacarContentTabs = UnitContentService::contentTabSlugs('rentacar');
$rentacarTabs = array_merge([UnitContentService::generalTabSlug('rentacar'), 'hero'], $rentacarContentTabs, ['opinions', 'vehicles', 'rac-aliados', 'sucursales', 'terms', 'requirements', 'contact', 'payments', 'rac-reservations', 'rac-bars-rates', 'rac-rate-rules', 'rac-addons', 'rentacar-footer']);
$seminuevosContentTabs = UnitContentService::contentTabSlugs('seminuevos');
$seminuevosTabs = array_merge([UnitContentService::generalTabSlug('seminuevos'), 'semi-home'], $seminuevosContentTabs, ['semi-inventory', 'semi-opinions', 'semi-financing', 'semi-team', 'semi-sucursales', 'semi-contact', 'seminuevos-footer']);
$leasingContentTabs = UnitContentService::contentTabSlugs('leasing');
$leasingTabs = array_merge([UnitContentService::generalTabSlug('leasing'), 'leasing-home'], $leasingContentTabs, ['leasing-sucursales', 'leasing-flota', 'leasing-aliados', 'leasing-equipo', 'leasing-contacto', 'leasing-footer']);
...
$tallerTabs = array_merge([UnitContentService::generalTabSlug('taller'), 'taller-home'], $tallerContentTabs, ['taller-contacto', 'taller-sobre', 'taller-sucursales', 'taller-footer']);
...
<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <?php if ($showRentacar): ?>
        ...
        <div class="<?php echo admin_submenu_collapse_class($rentacarTabs, $defaultAdminTab); ?>" id="rentacar-submenu" data-bs-parent="#admin-sidebar-accordion">
            ...
            <?php if (admin_can_any(['rac_bars_rates', 'rac_reservations', 'vehicles'])): ?><a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link" href="/admin/rac-bars-rates.php" data-admin-perm="rac_bars_rates"><i class="bi bi-currency-exchange me-2"></i> Tarifas BARS</a><?php endif; ?>
            <?php if (AdminUserService::isSuperAdmin() || admin_can('rac_bars_lab')): ?><a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link" href="/admin/rac-bars-api-lab.php" data-admin-perm="rac_bars_lab"><i class="bi bi-lightning-charge-fill me-2"></i> BARS / Partner Lab</a><?php endif; ?>
            <?php if (admin_can_any(['rac_rate_rules', 'rac_reservations', 'vehicles'])): ?><a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link" href="/admin/rac-rate-rules.php" data-admin-perm="rac_rate_rules"><i class="bi bi-percent me-2"></i> Reglas de Tarifas</a><?php endif; ?>
            <?php if (admin_can_any(['rac_addons', 'rac_reservations', 'vehicles'])): ?><a class="nav-link text-start w-100 border-0 bg-transparent text-decoration-none admin-sidebar-page-link" href="/admin/rac-addons.php" data-admin-perm="rac_addons"><i class="bi bi-shield-plus me-2"></i> Protecciones y Extras</a><?php endif; ?>
